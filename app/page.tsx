            ...
            {!selectedChannelId ? (
              ...
              >
                <motion.button
                  ...
                  className="mb-6 sm:mb-8 px-3 py-2 rounded-md bg-white shadow-sm border border-gray-200 text-gray-700 flex items-center gap-2 text-sm font-medium hover:bg-gray-50 transition-colors"
                  whileHover={{ x: -2 }}
                  whileTap={{ scale: 0.98 }}
                >
                  ← Back to Search
